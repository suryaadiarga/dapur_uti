<x-app-layout>
    ...
    <div class="mb-6"><a href="{{ route('inventories.index') }}" class="text-sm font-medium text-emerald-700">← Kembali</a><h1 class="page-title mt-3">{{ $inventory->exists ? 'Edit Inventaris' : 'Tambah Inventaris' }}</h1></div>
