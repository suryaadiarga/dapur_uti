    ...
    <div class="glass-card rounded-2xl border border-slate-800 bg-slate-900/80 p-6 sm:p-8 shadow-xl backdrop-blur-md">
        ...
        <form method="POST" action="{{ route('login') }}" class="mt-7 space-y-5">
            ...
            <div>
                ...
                <!-- Perhatikan text-white di bawah ini agar teks ketikan tidak gelap -->
                <input id="email" class="w-full rounded-xl bg-slate-950/80 border border-slate-700/60 px-4 py-2.5 text-sm text-white placeholder-slate-500 focus:border-indigo-500 focus:outline-none transition" type="email" name="email" value="{{ old('email') }}" required autofocus autocomplete="username">
            ...
            <div>
                ...
                <div class="relative">
                    <!-- Perhatikan text-white dan pr-10 di bawah ini -->
                    <input id="password" class="w-full rounded-xl bg-slate-950/80 border border-slate-700/60 pl-4 pr-10 py-2.5 text-sm text-white placeholder-slate-500 focus:border-indigo-500 focus:outline-none transition" type="password" name="password" required autocomplete="current-password">
