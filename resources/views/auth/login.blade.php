    ...
    <div class="glass-card rounded-2xl border border-slate-800 bg-slate-900/80 p-6 sm:p-8 shadow-xl backdrop-blur-md">
        ...
        <form method="POST" action="{{ route('login') }}" class="mt-7 space-y-5">
            ...
            <div>
                ...
                <input id="email" class="w-full rounded-xl bg-slate-950/60 border border-slate-800 px-4 py-2.5 text-sm text-slate-100 placeholder-slate-500 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 focus:outline-none transition shadow-sm" type="email" name="email" value="{{ old('email') }}" required autofocus autocomplete="username" placeholder="admin@dapuruti.com">
            ...
            <div>
                ...
                <div class="relative">
                    <input id="password" class="w-full rounded-xl bg-slate-950/60 border border-slate-800 pl-4 pr-10 py-2.5 text-sm text-slate-100 placeholder-slate-500 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 focus:outline-none transition shadow-sm" type="password" name="password" required autocomplete="current-password" placeholder="••••••••">
