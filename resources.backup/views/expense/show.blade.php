<x-app-layout>
    ...
    <div class="mb-6 flex items-start justify-between gap-4"><div><a href="{{ route('expense.index') }}" class="text-sm font-medium text-blue-700">← Kembali</a><h1 class="page-title mt-3">Detail Uang Keluar</h1></div><a href="{{ route('expense.edit', $transaction) }}" class="btn-secondary">Edit</a></div>
